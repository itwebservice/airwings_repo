	...
	<div class="col-md-12">
		...
		<h3>Basic Details</h3>
        	 	...
        	 	<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd; min-height: 105px;">
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Preferred Currency <em>:</em></label>".$sq_currency['currency_name'] ?>
		            </span>
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
        	 	...
        	 	<div class="col-md-6">	
					...
					<?php
					if($query['logo_url']!=''){
						$newUrl1 = preg_replace('/(\/+)/','/',$query['logo_url']);
					?>
					<span class="main_block">
					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					<?php echo "<label>Logo <em>:</em></label> "?><a href="<?php echo $newUrl1; ?>" download title="Download"><i class="fa fa-id-card-o"></i></a> 
					</span>
					<?php } ?>
	                <span class="main_block">
	                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	                  <?php echo "<label>Active Flag <em>:</em></label> ".$query['active_flag']; ?>
	                </span>
					<?php
					if($query['agreement_url']!=''){
						$newUrl1 = preg_replace('/(\/+)/','/',$query['agreement_url']);
					?>
					<span class="main_block">
					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		...
		<h3>Address Details</h3>
        	 	...
        	 	<div class="col-md-12 right_border_none_sm" style="min-height: 105px;">
		            ...
		            <span class="main_block">
        	 		...
        	 		<span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>City <em>:</em></label> ".$query['city'] ?>
		            </span>
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Country <em>:</em></label> ".$sq_country['country_name']; ?>
		            </span> 
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					...
					if($query['address_proof_url']!=''){
						$newUrl1 = preg_replace('/(\/+)/','/',$query['address_proof_url']);
					?>
					<span class="main_block">
					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
	...
	<div class="col-md-6">
		...
		<h3>Access Details</h3>
        	 	...
        	 	<div class="col-md-12 right_border_none_sm" style="min-height: 105px;">
		            ...
		            <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Username <em>:</em></label> ".$query['address2'] ?>
		            </span>
        	 		<span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>Password <em>:</em></label> ".$query['city'] ?>
		            </span>       
		        </div>
		        </div>   
		    </div> 
