...
<div class="app_panel_content Filter-panel">
    <div class="row">
        <div class="col-md-3 col-sm-6 mg_bt_10_xs">
            <select name="approve_status" id="approve_status" title="Active Flag" onchange="customer_list_reflect()">
        ...
        <div class="col-md-3 col-sm-6 mg_bt_10_xs">
            <select name="active_flag_filter" id="active_flag_filter" title="Active Flag" onchange="customer_list_reflect()">
