									    ...
									    <div class="table-responsive">
										    <table id="tbl_package_tour_quotation_dynamic_train" name="tbl_package_tour_quotation_dynamic_train" class="table table-bordered no-marg pd_bt_51">
										        <tr>
										            ...
										            <td class="col-md-2"><input type="text" id="train_departure_date" name="train_departure_date" placeholder="Departure Date" title="Departure Date" class="app_datetimepicker" onchange="get_to_datetime(this.id,'train_arrival_date')" value="<?= date('d-m-Y H:i:s') ?>"></td>
										            <td class="col-md-2"><input type="text" id="train_arrival_date" name="train_arrival_date" placeholder="Arrival Date" title="Arrival Date" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>"></td>
									            </tr>                   
									        </table>
										</div>
									</div>
						    ...
						    <div class="col-xs-12">
						        <div class="table-responsive">
							        <table id="tbl_package_tour_quotation_dynamic_plane" name="tbl_package_tour_quotation_dynamic_plane" class="table table-bordered no-marg pd_bt_51">
							            <tr>
							                <td><input class="css-checkbox" id="chk_plan1" type="checkbox" checked><label class="css-label" for="chk_plan1"> <label></td>
							                <td><input maxlength="15" value="1" type="text" name="username" placeholder="Sr. No." class="form-control" disabled /></td>
							                ...
							                <td><select id="plane_from_location-1" class="form-control" title="Sector From Location" name="plane_from_location1" style="width: 200px;">
							                ...
							                <?php get_cities_dropdown(); ?>
							                 ...
							                 <td><select id="plane_to_location-1" class="form-control"  title="Sector To Location" name="plane_to_location1" style="width: 200px;">
								            ...
								            <td><select name="plane_class" id="plane_class1" title="Class">
								            	<option value="">Class</option>
								            ...
								            <td><input type="text" id="txt_dapart1" name="txt_dapart" class="app_datetimepicker" placeholder="Departure Date & Time" title="Departure Date & Time" onchange="get_to_datetime(this.id,'txt_arrval1')" value="<?= date('d-m-Y H:i:s') ?>" /></td>
								            <td><input type="text" id="txt_arrval1" name="txt_arrval" class="app_datetimepicker" placeholder="Arrival Date Time" title="Arrival Date Time" value="<?= date('d-m-Y H:i:s') ?>"/></td>
							            </tr>
							        </table>
						        </div>
						    </div>
							        ...
							        <div class="table-responsive">
								        <table id="tbl_dynamic_cruise_quotation" name="tbl_dynamic_cruise_quotation" class="table table-bordered no-marg">
								            <tr>
								                ...
								                <td><input maxlength="15" value="1" type="text" name="username" placeholder="Sr. No." class="form-control" disabled /></td>
									            <td><input type="text" id="cruise_departure_date" name="cruise_departure_date" placeholder="Departure Date Time" title="Departure Date Time" onchange="get_to_datetime(this.id,'cruise_arrival_date')" class="app_datetimepicker" onchange="get_to_datetime(this.id,'cruise_arrival_date')" value="<?= date('d-m-Y H:i:s') ?>"></td>
									            <td><input type="text" id="cruise_arrival_date" name="cruise_arrival_date" placeholder="Arrival Date Time" title="Arrival Date Time" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>"></td>
