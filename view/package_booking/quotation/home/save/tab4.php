...
<!--=======Header panel end======-->
	...
	<div class="bg_white main_block panel-default-inner">
		...
		<div class="main_block text-center mg_bt_10">
			<div class="col-xs-12">
				<textarea id="txt_special_request" onchange="validate_address(this.id)" name="txt_special_request" placeholder="Remark" title="Remark" rows="2"></textarea>
			</div>
		</div>
	</div>
	</div>
...
$('#frm_tab4').validate({
	...
	submitHandler:function(form){
	  ...
	  for(var e=0; e<rowCount; e++)
	  {
		...
		var txt_special_request = $('#txt_special_request').val();
