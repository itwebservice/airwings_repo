								    ...
								    <div class="col-xs-12">
								        ...
								        <table id="tbl_package_tour_quotation_dynamic_train" name="tbl_package_tour_quotation_dynamic_train" class="table mg_bt_0 table-bordered pd_bt_51">
								            <tr>
									            ...
									            <td class="col-md-3"><input type="text" id="train_departure_date" name="train_departure_date" placeholder="Departure Datetime" title="Departure Datetime" class="app_datetimepicker" onchange="get_to_datetime(this.id,'train_arrival_date')" value="<?= date('d-m-Y H:i') ?>"  style="width:100%"></td>
									            <td class="col-md-3"><input type="text" id="train_arrival_date" name="train_arrival_date" placeholder="Arrival Datetime" title="Arrival Datetime" class="app_datetimepicker" value="<?= date('d-m-Y H:i') ?>" style="width:100%"></td>
								            </tr>                                
								        </table>
								        </div>
								    </div>
								    ...
								    <div class="col-xs-12">
								        ...
								        <table id="tbl_package_tour_quotation_dynamic_plane" name="tbl_package_tour_quotation_dynamic_plane" class="table mg_bt_0 table-bordered pd_bt_51">
								            <tr>
									            ...
									            <td><input type="text" id="txt_dapart1" name="txt_dapart" class="app_datetimepicker" placeholder="Departure Datetime" title="Departure Datetime" onchange="get_to_datetime(this.id,'txt_arrval1')" value="<?= date('d-m-Y H:i:s') ?>" style="width: 150px;" /></td>
									            <td><input type="text" id="txt_arrval1" name="txt_arrval" class="app_datetimepicker"  placeholder="Arrival Datetime" title="Arrival Datetime" value="<?= date('d-m-Y H:i:s') ?>" style="width: 150px;"/></td>
								            </tr>                                
								        </table>
								        </div>
								    </div>
								    ...
								    <div class="col-md-12">
								        ...
								        <table id="tbl_dynamic_cruise_quotation" name="tbl_dynamic_cruise_quotation" class="table table-bordered no-marg">
								            <tr>
								                ...
								                <td><input maxlength="15" value="1" type="text" name="username" placeholder="Sr. No." class="form-control" disabled /></td>
									            <td><input type="text" id="cruise_departure_date"  name="cruise_departure_date" placeholder="Departure Datetime"  title="Departure Datetime" class="app_datetimepicker" onchange="get_to_datetime(this.id,'cruise_arrival_date')" value="<?= date('d-m-Y H:i:s') ?>"></td>
									            <td><input type="text" id="cruise_arrival_date" name="cruise_arrival_date" placeholder="Arrival Datetime" title="Arrival Datetime" class="app_datetimepicker" value="<?= date('d-m-Y H:i:s') ?>"></td>
...
$('#plane_from_location1,#plane_to_location1,#train_from_location1,#train_to_location1,#airline_name1,#city_name-1').select2();
	...
	var table = document.getElementById("tbl_package_tour_quotation_dynamic_hotel");
		...
		var rowCount = table.rows.length;
		  ...
		  $.ajax({
		      ...
		      data:{ hotel_id_arr : hotel_name_arr,from_date : from_date },
		      ...
		      success:function(result){
		      	     ...
		      	     for(var i=0; i<hotel_arr.length; i++){
				      		...
				      		var row = table.rows[i]; 
			      	     	...
			      	     	row.cells[9].childNodes[0].value = hotel_arr[i]['hotel_cost'];

			      	     	row.cells[11].childNodes[0].value = hotel_arr[i]['extra_bed_cost'];
