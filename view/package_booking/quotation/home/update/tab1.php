...
<!--=======Header panel end======-->
	...
	<div class="row mg_tp_10">	
	    ...
	    <div class="col-md-4 col-sm-6 col-xs-12">
	    	...
	    	<input type="text" id="total_children12" name="total_children12" placeholder="Total Children" title="Total Children" onchange="total_passangers_calculate('12'); validate_balance(this.id)" value="<?= $sq_quotation['total_children'] ?>">
	...
	<div class="row mg_tp_10">	
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			...
			<input type="text" class="form-control" id="children_without_bed12" name="children_without_bed12" title="Children Without Bed" onchange="validate_balance(this.id)" placeholder="Children Without Bed" title="Children Without Bed" value="<?= $sq_quotation['children_without_bed'] ?>">

		</div>

		<div class="col-md-4 col-sm-6 col-xs-12">

			<input type="text" class="form-control" id="children_with_bed12" name="children_with_bed12" title="Children With Bed" onchange="validate_balance(this.id)" placeholder="Children With Bed" title="Children With Bed" value="<?= $sq_quotation['children_with_bed'] ?>">   
