        ...
        <table id="tbl_package_tour_quotation_dynamic_plane" name="tbl_package_tour_quotation_dynamic_plane" class="table mg_bt_0 table-bordered mg_bt_10 pd_bt_51">
			...
			if($sq_plane_count==0){
				...
				<tr>
		            ...
		            <td><input type="text" id="txt_dapart1" name="txt_dapart1"  class="app_datetimepicker" placeholder="Departure Datetime" onchange="get_to_datetime(this.id,'txt_arrval1')" title="Departure Datetime" style="width:130px" /></td>	           
		            <td><input type="text" id="txt_arrval1" name="txt_arrval1" class="app_datetimepicker" placeholder="Arrival Datetime" title="Arrival Datetime" style="width:130px" /></td>
				...
				while($row_q_plane = mysql_fetch_assoc($sq_q_plane)){
					...
					?>
					<tr>
						<td><input class="css-checkbox" id="chk_plan<?= $count ?>_1" type="checkbox" disabled checked><label class="css-label" for="chk_plan<?= $count ?>_1"> </label></td>
			            ...
			            <td><input type="text" id="txt_dapart<?= $count ?>_1" name="txt_dapart" class="app_datetimepicker" placeholder="Departure Datetime" title="Departure Datetime" onchange="get_to_datetime(this.id,'txt_arrval<?= $count ?>_1')" value="<?= date('d-m-Y H:i:s', strtotime($row_q_plane['dapart_time'])) ?>" style="width:130px" /></td>
			            <td><input type="text" id="txt_arrval<?= $count ?>_1" name="txt_arrval" class="app_datetimepicker" placeholder="Arrival Datetime" title="Arrival Datetime" value="<?= date('d-m-Y H:i:s', strtotime($row_q_plane['arraval_time'])) ?>" style="width:130px" /></td>
