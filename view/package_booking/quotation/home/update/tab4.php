<form id="frm_tab4">
	...
	<div class="bg_white main_block panel-default-inner">
		<div class="main_block"> 
			<div class="col-xs-12">
				<textarea id="txt_special_request" name="txt_special_request" placeholder="Remark" onchange="validate_address(this.id)" title="Remark"><?php echo $sq_quotation['special_request'] ?></textarea>
			</div> 
		</div>
	</div>
	</div>
