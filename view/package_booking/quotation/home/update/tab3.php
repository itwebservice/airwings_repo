							    ...
							    <div class="col-xs-12">
							        ...
							        <?php 
							            ...
							            <tr>
							                ...
							                <td><input class="css-checkbox" id="chk_transport1" type="checkbox" checked disabled><label class="css-label" for="chk_transport1" > </label></td>
								    ...
								    <div class="col-xs-12">
								        ...
								        <?php 
								            ...
								            <?php
								                ...
								                <td><input class="css-checkbox" id="chk_tour_group-<?= $count ?>" type="checkbox" disabled checked><label class="css-label" for="chk_tour_group2"> <label></td>
