  ...
  for(var i=0; i<rowCount; i++){
    ...
    var current_row = parseInt(i)+1;
     ...
     if(row.cells[0].childNodes[0].checked){
      ...
      validate_dynamic_empty_fields(row.cells[6].childNodes[0]);
      validate_dynamic_empty_fields(row.cells[7].childNodes[0]);
      // validate_dynamic_empty_fields(row.cells[8].childNodes[0]);
      validate_dynamic_empty_fields(row.cells[9].childNodes[0]);
      validate_dynamic_empty_fields(row.cells[10].childNodes[0]);
      ...
      if(row.cells[4].childNodes[0].value==""){ validate_message += "From location in row-"+(i+1)+" is required<br>"; }
      //if(row.cells[5].childNodes[0].value==""){ validate_message += "To City in row-"+(i+1)+" is required<br>"; }
      if(row.cells[6].childNodes[0].value==""){ validate_message += "To location in row-"+(i+1)+" is required<br>"; }
      if(row.cells[7].childNodes[0].value==""){ validate_message += "Airline Name in row-"+(i+1)+" is required<br>"; }
      
      if(row.cells[9].childNodes[0].value==""){ validate_message += "Amount in row-"+(i+1)+" is required<br>"; }
      if(row.cells[10].childNodes[0].value==""){ validate_message += "Arrival Date and time in row-"+(i+1)+" is required<br>"; }
