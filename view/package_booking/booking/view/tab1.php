	...
	<div class="col-md-8 col-sm-12 col-xs-12">
		...
		<div class="profile_box main_block" style="min-height: 217px;">
    	 	...
    	 	<h3>Customer Details</h3>
				...
				<?php $sq_customer = mysql_fetch_assoc(mysql_query("select * from customer_master where customer_id='$sq_package_info[customer_id]'"));
    		...
    		<div class="row">
	            ...
	            <div class="col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
					...
					<span class="main_block">
					    ...
					    <?php echo "<label>Email <em>:</em></label> " .$sq_customer['email_id']; ?>
					...
					<span class="main_block">
					    ...
					    <?php echo "<label>Mobile No <em>:</em></label>" .$sq_customer['contact_no']; ?> 
	...
	<div class="profile_box main_block">
		...
		<div class="row">
			<div class="col-xs-12">
				<span class="main_block">
				  	<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
				  <?php echo "<label>Due Date <em>:</em></label> ".get_date_user($sq_package_info['due_date']);?> 
				</span>
				<span class="main_block">
				  	<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
