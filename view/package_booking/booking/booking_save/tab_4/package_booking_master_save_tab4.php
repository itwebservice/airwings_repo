                    ...
                    <div class="bg_white main_block panel-default-inner">
                        <div class="main_block text-center">
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                ...
                                <input type="text" id="txt_hotel_expenses" name="txt_hotel_expenses" placeholder="Tour Amount" title="Tour Amount" onchange="validate_balance(this.id);calculate_tour_cost()" value="0">   
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                <label for="txt_tour_cost">Markup</label>
                                <input type="text" id="txt_tour_cost" name="txt_tour_cost" placeholder="Markup Cost" title="Markup Cost" value="0" onchange="validate_balance(this.id);calculate_tour_cost()">    
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                                <label for="txt_total_tour_cost">Subtotal</label>
                                <input type="text" id="subtotal" name="subtotal" placeholder="Subtotal" title="Subtotal" value="0" onchange="validate_balance(this.id); calculate_total_tour_cost()">    
                            </div>   
                        ...
                        <div class="main_block text-center">
                            <div class="col-md-3 col-sm-6 col-xs-12 col-xs-12 mg_bt_10_xs">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs">
                                ...
                                <input type="text" id="tour_service_tax_subtotal" name="tour_service_tax_subtotal" value="0">
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <label for="txt_actual_tour_cost1">Tour Amount</label>
                ...
                <div class="panel panel-default panel-body main_block bg_light mg_bt_30">
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        <div class="main_block text-center mg_bt_10">
                            <div class="col-md-2 col-md-offset-1 col-sm-4 col-xs-12 mg_bt_10_xs">
                    ...
                    <div class="bg_white main_block panel-default-inner">
                            ...
                            <div class="panel panel-default panel-body pad_8 mg_tp_20 mg_bt_20 legend_pan bk_payment_wrap">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-4 mg_bt_10_xs">
                                        <label class="legend_text">Tour </label>
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                        <select id="cmb_payment_mode1" name="cmb_payment_mode1" title="Mode" onchange="payment_installment_enable_disable_fields('1')"><?php get_payment_mode_dropdown(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                        <input type="text" id="txt_amount1" name="txt_amount1" placeholder="*Amount" title="Amount" onchange="validate_balance(this.id);payment_amount_validate(this.id,'cmb_payment_mode1','txt_transaction_id1','txt_bank_name1')"  />
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default panel-body pad_8 legend_pan bk_payment_wrap" style="margin-top: 30px;">
                                <div class="row">
                                        <div class="chk_wrap">
                                            <input type="checkbox" id="chk_pay_for_traveling" style="float:left;" checked>
                                        </div>
                                        <div class="col-md-2 col-sm-4 mg_bt_10_xs">
                ...
                <div class="panel panel-default panel-body main_block bg_light mg_bt_30">
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        ...
                        <div class="main_block mg_bt_20">    
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs">
                                <input type="text" id="txt_booking_date" name="txt_booking_date" placeholder="Booking Date" title="Booking Date" value="<?php echo date('d-m-Y H:i:s') ?>" onchange="check_valid_date(this.id)"/>
                            </div>
                        </div>
                    </div>
                </div>
