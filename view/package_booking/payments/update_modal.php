...
$bank_detail_state = ($sq_payment['payment_mode']=="Cash") ? "disabled" : "";
        ...
        <form id="frm_update_payment">    
            ...
            <div class="row mg_bt_10">         
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" type="text" id="txt_amount" title="Amount" name="txt_amount" placeholder="Amount" onchange="validate_balance(this.id);" value="<?php echo $sq_payment['amount'] ?>"/>

                </div>                  

                <div class="col-md-4">

                    <input class="form-control bank_suggest" type="text" id="txt_bank_name" title="Creditor Bank" name="txt_bank_name" placeholder="Bank Name" value="<?php echo $sq_payment['bank_name'] ?>" <?= $bank_detail_state ?>/>
  ...
  submitHandler:function(form){
      ...
      $('#btn_update').button('loading');
        ...
        $.post( 
           ...
           { payment_id : payment_id, booking_id : booking_id, payment_date : payment_date, payment_mode : payment_mode, payment_amount : payment_amount, bank_name : bank_name, transaction_id : transaction_id, payment_for : payment_for, p_travel_type : p_travel_type, bank_id : bank_id, payment_old_value : payment_old_value },
