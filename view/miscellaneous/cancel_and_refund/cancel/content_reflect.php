...
<div class="row mg_bt_20">
	...
	<div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-12 mg_bt_20_xs">
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                $title_arr = array("Basic Sale","Serv. Charge", " Tax", "Total Amount");
	                $content_arr = array( number_format($visa_amount,2) ,number_format($service_charge,2), number_format($subtotal_amount,2), number_format($sq_visa_info['misc_total_cost'],2));
...
<form id="frm_refund">
	...
	<div class="row text-center">
		<div class="col-md-3 col-md-offset-3 col-sm-6 col-xs-12 mg_bt_10_xs">
			<input type="text" name="cancel_amount" id="cancel_amount" class="text-right" placeholder="*Cancel Amount" title="Cancel Amount" onchange="validate_balance(this.id);calculate_total_refund()" value="<?= $sq_visa_info['cancel_amount'] ?>">
		</div>
