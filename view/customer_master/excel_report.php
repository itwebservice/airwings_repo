...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('S'.$row_count, "Active Flag");
...
while($row_customer = mysql_fetch_assoc($sq_customer)){
    ...
    $masked_email1 =  ($row_customer['email_id'] == "") ? 'NA' : $row_customer['email_id'];
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('H'.$row_count, $row_customer['contact_no'])
