      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-12">
                <input type="text" name="country" id="country" placeholder="Nationality" title="Nationality" value="<?= $sq_customer['country'] ?>"/>
              </div>
              <div class="col-sm-4 mg_bt_10_sm_xs">
