...
<div class="modal fade" id="branch_update_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="modal-body">
        ...
        <div class="row"> <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 mg_bt_10">
              <input type="text" id="branch_name" name="branch_name"  placeholder="Branch Name" class="form-control" title="Branch Name" value="<?= $sq_branch['branch_name'] ?>">
            </div> 
