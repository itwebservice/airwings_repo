      ...
      <div class="modal-body">
            ...
            <div class="row"> 
              <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                  <select id="email_type" name="email_type" style="width:100%" title="Type" disabled>
                      <option value="<?= $sq_type['type_id'] ?>"><?= $type ?></option>
                  </select>
              </div>
              <div class="col-md-3 col-sm-6 mg_bt_10_xs">
              ...
              <div class="col-md-6 col-sm-6 mg_bt_10_xs">
                <textarea id="subject" name="subject" placeholder="Subject Title Eg. Visa Booking Confirmation" title="Subject Title" rows="1" disabled><?= $row_update['subject'] ?></textarea>
              </div>    
            </div>
            ...
            <div class="row mg_tp_20">            
              <div class="col-md-3 col-sm-6 mg_bt_10_xs">
                  <select id="active_flag" name="active_flag" style="width:100%" title="Active Flag">
...
$(function(){
  $('#frm_cms_save').validate({
    ...
    submitHandler:function(form){
      ...
      var draft = $("#draft").val();
      // $('#draft_reader').html(draft);
      // $('div, b, span, font').css({"background-color": "transparent", "color": "#ffffff",  "line-height": "21px", "font-family" : "Roboto, sans-serif"});
      // var draft = $("#draft_reader").html();

      var signature = $("#signature").val();
      // $('#draft_reader').html(signature);
      // $('div, b, span, font').css({"background-color": "transparent", "color": "#ffffff",  "line-height": "21px", "font-family" : "Roboto, sans-serif", "font-size" : "initial"});
      // var signature = $("#draft_reader").html();
