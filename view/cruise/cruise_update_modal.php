      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
            <legend>Cruise Supplier Information</legend>
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <input type="text" class="form-control" value="<?= $sq_cruise_info['mobile_no'] ?>" id="mobile_no1" name="mobile_no1" placeholder="Mobile Number" onchange="mobile_validate(this.id);" title="Mobile Number">
                  </div>
                  <div class="col-md-3 col-sm-6 mg_bt_10">
              ...
              <div class="row">                  
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <input type="text" class="form-control" value="<?= $sq_cruise_info['email_id'] ?>" id="email_id1" name="email_id1"  placeholder="Email ID" title="Email ID">
                  </div>
                  <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
           ...
           <div class="col-md-3 col-sm-6 mg_bt_10">
              <input type="text" id="opening_balance1" name="opening_balance1" class="form-control" placeholder="Opening Balance" title="Opening Balance" value="<?= $sq_cruise_info['opening_balance'] ?>" <?= $value ?>  onchange="validate_balance(this.id)">
          </div> 
          <div class="col-sm-3 mg_bt_10">
            <input type="text" id="as_of_date1" name="as_of_date1" placeholder="*As of Date" title="As of Date" value="<?= get_date_user($sq_cruise_info['as_of_date']) ?>">
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 mg_bt_10">
              <select name="active_flag1" id="active_flag1" title="Active Flag" class="form-control">
