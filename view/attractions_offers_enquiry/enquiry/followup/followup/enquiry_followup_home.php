    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	   ...
	   <div class="row mg_bt_10">
		 <div class="col-md-12">
			<textarea id="followup_reply" name="followup_reply" onchange="validate_spaces(this.id);" placeholder="*Followup Description" class="form-control" title="Followup Description"></textarea>
		 </div>		
	   </div>
