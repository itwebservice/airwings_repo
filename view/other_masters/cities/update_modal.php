...
<div class="modal fade" id="city_master_update_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="modal-body text-center">
          ...
          <div class="row mg_bt_10">
            ...
            <div class="col-sm-6 mg_bt_10">
              ...
              <select name="active_flag" id="active_flag" title="Active Flag" class="form-control" required>
          ...
          $.post( 
                ...
                var msg = data.split('--');
                  ...
                  return false;
                       ...
                       $('#update_city').button('reset');
                       $('#city_master_update_modal').on('hidden.bs.modal', function(){
                          list_reflect();
                       });
               }
            });
