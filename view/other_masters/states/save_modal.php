        ...
        <div class="row"> <div class="col-md-12"> <div class="table-responsive">
          ...
          <table id="tbl_dynamic_state_name" name="tbl_dynamic_state_name" class="table border_0 table-hover no-marg"  cellspacing="0">
              <tr>
                  ...
                  <td><select name="active_flag1" id="active_flag1" class="form-control hidden" title="Active Flag">
...
$('#state_save_modal').modal({backdrop: 'static', keyboard: false});
</script>
               ...
               function(data) {   
                ...
                if(msg[0]=="error"){
                  ...
                  $('#btn_state_save').button('reset');
                    ...
                    $('#state_save_modal').on('hidden.bs.modal', function(){
                          list_reflect();
                    });
                  } 
               });
