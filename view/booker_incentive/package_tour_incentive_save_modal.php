...
$total_amount = $sq_total_amount['total_travel_expense'] + $sq_total_amount['actual_tour_expense'];
$basic_amount = ($total_amount*($incentive/100));
//$basic_amount1 = number_format($basic_amount,2);
?>

<form id="frm_incentive_save">
<div class="modal fade" id="group_tour_incentive_save_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		$('#frm_incentive_save').validate({
			...
			submitHandler:function(form){
				...
				$.ajax({
					...
					data:{ booking_id : booking_id, emp_id : emp_id, basic_amount : basic_amount, tds : tds, incentive_amount : incentive_amount },
