...
<div class="modal fade" id="package_tour_incentive_edit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	$(function(){
		$('#frm_incentive_edit').validate({
			...
			submitHandler:function(form){
				...
				$.ajax({
					type:'post',
					url: base_url+'controller/booker_incentive/package_tour_incentive_update.php',
