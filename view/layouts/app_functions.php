...
function topbar_icon_list()
{
    ...
    <li class="financial_yr">
        <a href="javascript:void(0)" class="btn app_btn_out" title="Financial Year"><i class="fa fa-code-fork"></i><span class="">&nbsp;&nbsp;<?php echo get_date_user($sq_finacial_year['from_date']).' - '.get_date_user($sq_finacial_year['to_date']); ?></span></a>
    </li>  
