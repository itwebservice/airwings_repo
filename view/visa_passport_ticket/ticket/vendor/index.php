...
?>
<?= begin_panel('Flight Ticket Supplier Information',25) ?>

<div class="row text-right mg_bt_20">
	<div class="col-md-12">
		<button class="btn btn-info btn-sm ico_left" data-toggle="modal" data-target="#save_modal"><i class="fa fa-plus"></i>&nbsp;&nbsp;Ticket Supplier</button>
	</div>
</div>
