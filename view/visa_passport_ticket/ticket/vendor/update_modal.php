    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="mobile_no1" name="mobile_no1" onchange="mobile_validate(this.id);" placeholder="Mobile No" title="Mobile No" value="<?= $sq_vendor['mobile_no'] ?>">
          </div> 
          <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row"> 
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="opening_balance1" onchange="validate_balance(this.id)" name="opening_balance1" placeholder="Opening Balance" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>">
          </div> 
