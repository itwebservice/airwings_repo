    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row"> 
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="opening_balance1" name="opening_balance1" onchange="validate_balance(this.id);" placeholder="Opening Balance" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>" <?= $value ?>  >
          </div>     			
