...
while($row_train_ticket_payment = mysql_fetch_assoc($sq_train_ticket_payment)){
        if($row_train_ticket_payment['payment_amount'] != '0'){
            ...
            if($row_train_ticket_payment['clearance_status']=="Pending"){ 
                $sq_pending_amount = $sq_pending_amount + $row_train_ticket_payment['payment_amount'];
            }
            else if($row_train_ticket_payment['clearance_status']=="Cancelled"){ 
                $sq_cancel_amount = $sq_cancel_amount + $row_train_ticket_payment['payment_amount'];
            }
            $sq_paid_amount = $sq_paid_amount + $row_train_ticket_payment['payment_amount'];
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('F'.$row_count,  $row_train_ticket_payment['payment_amount'])
        ...
        ->setCellValue('F'.$row_count, 'Cancel Amount : '.$sq_cancel_amount)
