      ...
      <div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-sm-6 mg_bt_10">
					...
					<select name="city_id" id="city_id" title="City Name" style="width:100%">
					  ...
					  <option value="<?= $sq_ser['city_id'] ?>"><?= $sq_city['city_name'] ?></option>
				...
				<div class="col-sm-6 mg_bt_10">
					...
					<input type="text" id="service_name" name="service_name" placeholder="*Excursion Name" title="Excursion Name" value="<?= $sq_ser['service_name'] ?>">
			...
			<div class="row mg_bt_10">
				...
				<div class="col-sm-6 mg_bt_10">
	              ...
	              <select name="active_flag" id="active_flag1" title="Active Flag">
