...
<div class="app_panel_content Filter-panel">
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mg_bt_10_sm_xs">
            <select name="active_flag_filter" id="active_flag_filter" title="Active Flag" onchange="dmc_list_reflect()">
...
<div id="div_dmc_list" class="main_block loader_parent"></div>
