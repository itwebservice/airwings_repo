          ...
          <form id="frm_dmc_update">
            <div class="panel panel-default panel-body app_panel_style feildset-panel">
              ...
              <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <input type="text" class="form-control" value="<?= $sq_dmc_info['mobile_no'] ?>"  onchange="mobile_validate(this.id);" id="mobile_no1" name="mobile_no1" placeholder="Mobile Number" title="Mobile Number">
                  </div>
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <div class="row">                  
                  <div class="col-md-3 col-sm-6 mg_bt_10">
                      <input type="text" class="form-control" value="<?= $sq_dmc_info['email_id'] ?>" id="email_id1" name="email_id1"  placeholder="Email ID" title="Email ID">
                  </div>
                  <div class="col-md-3 col-sm-6 mg_bt_10">
           ...
           <div class="panel panel-default panel-body app_panel_style feildset-panel">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 mg_bt_10">
                  <input type="text" id="opening_balance1" name="opening_balance1" class="form-control" placeholder="Opening Balance" title="Opening Balance" value="<?= $sq_dmc_info['opening_balance'] ?>" <?= $value ?>  onchange="validate_balance(this.id)">
                </div>
                  <div class="col-sm-3 mg_bt_10">
                    <input type="text" id="as_of_date1" name="as_of_date1" placeholder="*As of Date" title="As of Date" value="<?= get_date_user($sq_dmc_info['as_of_date']) ?>">
                  </div>
                <div class="col-md-3 col-sm-6 mg_bt_10">
