							        		...
							        		<div class="row">
           										...
           										<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd">
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Mobile No <em>:</em></label> " .$sq_dmc['mobile_no'] ; ?>
							        				...
							        				<span class="main_block"> 
							        				    ...
							        				    <?php echo "<label>Email ID <em>:</em></label> " .$sq_dmc['email_id']; ?>
							        			...
							        			<div class="col-md-6">
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>As Of Date <em>:</em></label> " .get_date_user($sq_dmc['as_of_date']); ?>
													...
													<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Side <em>:</em></label> " .$sq_dmc['side']; ?>
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Active Flag <em>:</em></label> " .$sq_dmc['active_flag']; ?> 
