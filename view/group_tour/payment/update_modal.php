...
$enable_state = ($sq_payment['payment_mode']=="Cash") ? "disabled" : "";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="col-md-4">
              ...
              <input type="text" id="txt_amount" name="txt_amount" title="Amount" placeholder="Amount" value="<?= $sq_payment['amount'] ?>" onchange="validate_balance(this.id);" />

            </div>      

		      	<div class="col-md-4">

		          <input type="text" id="txt_bank_name" name="txt_bank_name" class="form-control bank_suggest" placeholder="Bank Name" title="Bank Name" value="<?= $sq_payment['bank_name'] ?>" <?= $enable_state ?> />

		        </div>      

		        <div class="col-md-4">

		          <input type="text" id="txt_transaction_id" onchange="validate_balance(this.id);" name="txt_transaction_id" class="form-control" placeholder="Cheque No/ID" title="Cheque No / ID" value="<?= $sq_payment['transaction_id'] ?>" <?= $enable_state ?> />
            ...
            <div class="col-md-4">
              ...
              <?php if($sq_payment['travel_type']!=''){ ?>
		        ...
		        <div class="col-md-4">
		          ...
		          <select name="bank_id" id="bank_id" title="Select Bank" class="form-control" <?= $enable_state ?> disabled>
  ...
  $('#frm_payment_update').validate({
    ...
    submitHandler:function(form){
      ...
      if(payment_for==""){
        ...
        error_msg_alert("Please enter payment for field.");

        $('#cmb_payment_of_type').focus();
      ...
      if(payment_for=='traveling'){  
        ...
        if(p_travel_type=="" ){
          ...
          error_msg_alert("Please select traveling type.");
      ...
      $.post( 
             ...
             { tourwise_traveler_id : tourwise_traveler_id, payment_id : payment_id, payment_date : payment_date, payment_mode : payment_mode, payment_amount : payment_amount, bank_name : bank_name, transaction_id : transaction_id, payment_for : payment_for, p_travel_type : p_travel_type, bank_id : bank_id, payment_old_value : payment_old_value },
