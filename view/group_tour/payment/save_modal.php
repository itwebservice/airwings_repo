			...
			<form id="frm_payment_save">
		      ...
		      <div class="row">
		        ...
		        <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
		          ...
		          <select id="cmb_payment_mode" name="cmb_payment_mode" title="Mode" onchange="payment_installment_enable_disable_fields()" class="form-control">
		          ...
		          <input type="text" class="form-control" id="txt_amount" name="txt_amount" title="Amount" placeholder="*Amount" onchange="validate_balance(this.id);payment_amount_validate(this.id,'cmb_payment_mode','txt_transaction_id','txt_bank_name','bank_id')"/>
		        ...
		        <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
		          ...
		          <select id="cmb_payment_of_type" name="cmb_payment_of_type" title="Receipt For" onchange="payment_installment_enable_disable_fields1(this.id)" class="form-control">
      ...
      $.post(base_url+'view/load_data/finance_date_validation.php', { check_date: check_date1 }, function(data){
          if(data !== 'valid'){
            ...
            $.post(
                  ...
                  { tourwise_id : tourwise_id, payment_date : payment_date, payment_mode : payment_mode, payment_amount : payment_amount, bank_name : bank_name, transaction_id : transaction_id, payment_for : payment_for, p_travel_type : p_travel_type, bank_id : bank_id, emp_id : emp_id, branch_admin_id : branch_admin_id },
