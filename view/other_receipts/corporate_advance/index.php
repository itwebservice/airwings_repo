...
function list_reflect()
{
	...
	var branch_status1 = $('#branch_status1').val();
	$.post('corporate_advance/list_reflect.php',{ from_date : from_date, to_date : to_date, cust_id : cust_id, financial_year_id : financial_year_id , branch_status : branch_status1}, function(data){
		$('#div_list').html(data);
	});
}
list_reflect();
