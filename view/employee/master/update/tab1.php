	     ...
	     <legend>User Information</legend>                
           ...
           <div class="row text-center mg_tp_10">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" type="text" id="txt_mobile_no11" onchange="mobile_validate(this.id);" name="txt_mobile_no" placeholder="Mobile No" value="<?= $emp_info['mobile_no'] ?>" title="Mobile Number">
       ...
       <legend>Official Information</legend>
        ...
        <div class="row text-center mg_tp_10">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <select name="location_id" id="location_id" title="Location" onchange="branch_name_load()">                    
                    ...
                    $sq_location = mysql_fetch_assoc(mysql_query("select * from locations where location_id='$location_id' order by location_name"));

                    echo '<option value="'.$sq_location['location_id'].'">'.$sq_location['location_name'].'</option>';
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" id="emp_username11" name="emp_username1" onchange="validate_username(this.id);" type="text" placeholder="Username" value="<?= $emp_info['username'] ?>" title="Username"/>
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
                ...
                <input class="form-control" id="txt_password1" onchange="validate_password(this.id);" name="txt_password" type="password" placeholder="Password" value="<?= $emp_info['password'] ?>" title="Password" />

            </div>  

          <div class="col-md-3 col-sm-6 mg_bt_10">

                <input class="form-control" id="txt_password11" onchange="validate_password(this.id);" name="txt_password1" type="password" placeholder="Confirm password" value="<?= $emp_info['password'] ?>" title="Confirm password" />
