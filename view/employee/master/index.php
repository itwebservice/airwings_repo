    ...
    <!-- Filter-panel -->
      ...
      <div class="app_panel_content Filter-panel">
         ...
         <div class="row">
            ...
            <?php if($role=='Admin'){ ?>
            <div class="col-md-3 col-sm-4 col-xs-12 mg_bt_10_xs">
               <select name="location_id_filter" id="location_id_filter" onchange="branch_name_load('_filter')" title="Select Location">
...
function excel_report()
{
  ...
  var location_id_filter = $('#location_id_filter').val();
  var branch_id_filter = $('#branch_id_filter').val();
    window.location = 'excel_report.php?role_filter='+role_filter+'&location_id_filter='+location_id_filter+'&branch_id_filter='+branch_id_filter;
}
</script>
