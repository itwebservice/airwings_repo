...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('U'.$row_count, "Opening Balance")
        ->setCellValue('V'.$row_count, "Side")
        ->setCellValue('W'.$row_count, "Hotel Type")
        ->setCellValue('X'.$row_count, "Active Flag");
...
while($row_hotel = mysql_fetch_assoc($sq_hotel)){
    ...
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('E'.$row_count, $row_hotel['mobile_no'])
        ->setCellValue('F'.$row_count, $row_hotel['landline_no'])
        ->setCellValue('G'.$row_count, $row_hotel['email_id'])
        ...
        ->setCellValue('U'.$row_count, $row_hotel['opening_balance'])
        ->setCellValue('V'.$row_count, $row_hotel['side'])
        ->setCellValue('W'.$row_count, $row_hotel['rating_star'])
