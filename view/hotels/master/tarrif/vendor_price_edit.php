      	...
      	<div class="modal-body">  	               
            <div class="row">
      		...
      		<div class="panel panel-default panel-body app_panel_style mg_tp_20"> 
	            <div class="row">
	                <div class="col-md-2">	                
						<input type="text" id="<?php echo "without_bed".$count_m ?>" onchange="name_validate(this.id); validate_spaces(this.id);" name="without_bed" placeholder="Room Category" title="Room Category" value="<?php echo $entry_row['without_bed_cost']; ?>" />
					</div>
					<div class="col-md-2">
...
$('#frm_bid_update').validate({
	...
	submitHandler:function(form){
		...
		var without_bed_cost =  $('#without_bed1').val();
