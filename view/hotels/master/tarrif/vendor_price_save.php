	                ...
	                <div class="col-md-12">
	                    ...
	                    <table id="table_vendor_pricing" name="table_vendor_pricing" class="table table-bordered no-marg pd_bt_51" style="min-width:1500px">
									 ...
									 <tr>
									    ...
									    <td><input type="text" onchange="validate_alphanumeric(this.id);" id="without_bed" name="without_bed" placeholder="Room Category" title="Room Category" /></td>
	            ...
	            <div class="row mg_tp_20">
	            	...
	            	<div class="col-md-4">
						<h3 class="editor_title">Inclusions</h3>
	              		<TEXTAREA  id="inclusions" class="feature_editor" style="width: 100%;" name="inclusions" placeholder="Inclusions" title="Inclusions" />

	              	</div>

	              	<div class="col-md-4">
						<h3 class="editor_title">Exclusions</h3>	
	             		 <TEXTAREA id="exclusions" class="feature_editor" style="width: 100%;" name="exclusions" placeholder="Exclusions" title="Exclusions" />

	             	</div>

	             	<div class="col-md-4">
						<h3 class="editor_title">Terms & Conditions</h3>
				  		<TEXTAREA id="terms_conditions" class="feature_editor" style="width: 100%;" name="terms_conditions" placeholder="Terms & Conditions" title="Terms & Conditions" />
...
$('#currency_code1,#meal_plan,#cmb_city_id,#cmb_hotel_id').select2();
	...
	submitHandler:function(form){
       ...
       for(var i=0; i<rowCount; i++)
		...
		$.ajax({
			...
			data:{ city_id : city_id,hotel_id : hotel_id,from_date_arr : from_date_arr, to_date_arr : to_date_arr, single_bed_arr : single_bed_arr, double_bed_arr : double_bed_arr, triple_bed_arr : triple_bed_arr, with_bed_arr: with_bed_arr,without_bed_arr : without_bed_arr,inclusions : inclusions, exclusions : exclusions, terms_conditions : terms_conditions,currency_code : currency_code, check_in : check_in, check_out : check_out, quad_bed_arr : quad_bed_arr,queen_arr : queen_arr, king_arr : king_arr, twin_arr : twin_arr, meal_plan_arr : meal_plan_arr},
