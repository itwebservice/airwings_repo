			...
			<div class="profile_box main_block">
	        	 	...
	        	 	<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd;">
			            ...
			            <span class="main_block">
			             ...
			             <span class="main_block">
			                  ...
			                  <?php echo "<label>Visa Country Name <em>:</em></label> ".$sq_tours['visa_country_name']; ?>
	        	 	...
	        	 	<div class="col-md-6">      
			            ...
			            <span class="main_block">
			                  ...
			                  <?php echo "<label>Insurance Company Name <em>:</em></label> ".$sq_tours['company_name']; ?>
			            ...
			            <span class="main_block">
			                  ...
			                  <?php echo "<label>Active Flag <em>:</em></label> ".$sq_tours['active_flag']; ?>
