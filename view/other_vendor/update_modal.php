    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" name="mobile_no" id="mobile_no" title="Mobile No" placeholder="Mobile No" onchange="mobile_validate(this.id);" value="<?= $sq_vendor['mobile_no'] ?>">
          </div>  
        </div>
        <div class="row">
          <div class="col-md-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" name="email_id" id="email_id" title="Email ID" placeholder="Email ID" value="<?= $sq_vendor['email_id'] ?>">
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
       ...
       <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="opening_balance" name="opening_balance" onchange="validate_balance(this.id);" placeholder="Opening Balance" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>" <?= $value ?> >
          </div>    
