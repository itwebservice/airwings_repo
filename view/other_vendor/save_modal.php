      ...
      <div class="modal-body">
       ...
       <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <input type="text" id="opening_balance" name="opening_balance" placeholder="Opening Balance" onchange="validate_balance(this.id)" title="Opening Balance" value="0.00">
          </div>    
