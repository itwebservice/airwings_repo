  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_10">
        ...
        <div class="row">
          <div class="col-sm-3 col-sm-6 mg_bt_10">
                <select id="cmb_city_id1" name="cmb_city_id1" style="width:100%" title="City Name">
                    ...
                    <option value="<?php echo $sq_vendor['city_id'] ?>"><?php echo $sq_city['city_name'] ?></option>
          ...
          <div class="col-sm-3 col-sm-6 mg_bt_10">
            <input type="text" id="mobile_no1"  onchange="mobile_validate(this.id);" name="mobile_no1" placeholder="Mobile No" title="Mobile No" value="<?= $sq_vendor['mobile_no'] ?>">
          </div>  
          <div class="col-sm-3 col-sm-6 mg_bt_10">
        ...
        <div class="row">
          <div class="col-sm-3 col-sm-6 mg_bt_10">
            <input type="text" name="email_id1" id="email_id1" value="<?= $sq_vendor['email']?>" placeholder='Email ID' title='Email ID'/>
          </div>
          <div class="col-sm-3 col-sm-6 mg_bt_10">
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-sm-6 mg_bt_10">
           <input type="text" id="opening_balance1" name="opening_balance1" placeholder="Opening Balance1" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>" <?= $value ?> onchange="validate_balance(this.id)">
          </div>
