    ...
    <div class="modal-content">
      ...
      <legend>Bank Information</legend> 
        ...
        <div class="row"> 
          ...
          <div class="col-sm-3 col-sm-6 mg_bt_10">
            <input type="text" id="opening_balance" class="form-control" name="opening_balance" placeholder="Opening Balance" title="Opening Balance" value="0" onchange="validate_balance(this.id)">
          </div>
        ...
        <div class="row">
           <div class="col-sm-3 col-sm-6 mg_bt_10">
            ...
            <div class="col-sm-3 col-sm-6 mg_bt_10">
              <select name="active_flag" id="active_flag" title="Active Flag" class="form-control hidden" style="width: 100%;">
       ...
       <div class="panel panel-default panel-body app_panel_style">
         <div class="row mg_bt_10">
          <div class="col-md-12 text-right text_center_xs">
            <button type="button" class="btn btn-info btn-sm ico_left" onClick="addRow('tbl_dynamic_car_rental_vehicle')"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</button>
            <button type="button" class="btn btn-danger btn-sm ico_left" onClick="deleteRow('tbl_dynamic_car_rental_vehicle')"><i class="fa fa-times"></i>&nbsp;&nbsp;Delete</button>
          </div>
         </div>    

        <div class="row"><div class="col-md-12"><div class="table-responsive">
            <table id="tbl_dynamic_car_rental_vehicle" name="tbl_dynamic_car_rental_vehicle" class="table table-bordered no-marg" style="width: 965px;">
                <tr>
