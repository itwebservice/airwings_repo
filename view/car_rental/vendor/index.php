...
?>
<?= begin_panel('Car Rental Supplier Information',23) ?>
...
<div class="app_panel_content Filter-panel">
	<div class="row">
		...
		<div class="col-md-3 col-sm-6 mg_bt_10_sm_xs">
	        <select name="active_flag_filter" id="active_flag_filter" title="Active Flag" onchange="vendor_list_reflect()">
...
function vendor_list_reflect()
{
	...
	$.post('vendor_list_reflect.php', { active_flag : active_flag, city_id : city_id }, function(data){
...
{
	$.post('vendor_update_modal.php', { vendor_id : vendor_id}, function(data){
...
function save_modal()
{
	...
	$.post('vendor_save.php', {}, function(data){
