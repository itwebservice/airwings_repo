                ...
                <div class="panel panel-default panel-body main_block bg_light mg_bt_30">
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                            ...
                            <input type="text" id="txt_children_seats" name="txt_children_seats" value="0" class="text-center form-control valid" title="No. of Children's" readonly/>           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10 text-center">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            <label>Adult</label>
                            <input type="text" id="txt_adult_expense" name="txt_adult_expense" title="Adult Cost" placeholder="Adult Cost" class="text-right form-control valid" onchange="tour_cost_calculate(); validate_balance(this.id)" />            
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            <label>Children</label>
                            <input type="text" id="txt_children_expense" title="Children Cost" placeholder="Children Cost" name="txt_children_expense" class="text-right form-control valid" onchange="tour_cost_calculate();validate_balance(this.id)"  />           
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                            <label>Infant</label>
                            <input type="text" id="txt_infant_expense" title="Infant Cost" placeholder="Infant Cost" name="txt_infant_expense" class="text-right form-control valid" onchange="tour_cost_calculate();validate_balance(this.id)"  />          
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10_xs text-center">
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        <div class="text-right text_center_xs mg_tp_10">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_repeater_discount" name="txt_repeater_discount" class="text-right" placeholder="Repeaters Travelling Discount" title="Repeaters Travelling Discount" onkeyup="calculate_total_discount()" value="0"  onchange="validate_balance(this.id);" />
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label>Adjustment discount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_adjustment_discount" name="txt_adjustment_discount" class="text-right" placeholder="Adjustment Discount" title="Adjustment Discount" onkeyup="calculate_total_discount()" value="0"  onchange="validate_balance(this.id);"/>
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label class="theme_col">Total Discount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10 text_center_xs">
                                <input type="text" id="txt_total_discount" name="txt_total_discount" class="text-right amount_feild_highlight" placeholder="Total Discount" title="Total Discount " readonly />
                            </div>
                        </div>
                        <div class="text-right text_center_xs">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="txt_tour_fee" onchange="validate_balance(this.id)" name="txt_tour_fee" class="text-right" placeholder="Tour Amount" title="Tour Amount" readonly />
                            </div>
                        ...
                        <div class="text-right text_center_xs">
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label>Subtotal</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label for="visa_total_amount">Insurance Amount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                        ...
                        <div class="text-right text_center_xs">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">        
                                <input type="text" id="txt_total_tour_fee" name="txt_total_tour_fee" class="text-right amount_feild_highlight" placeholder="Total Tour Amount" title="Total Tour Amount" readonly />
                            </div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10"><label class="theme_col">Total Travel Amount</label></div>
                            <div class="col-md-2 col-sm-3 col-xs-12 mg_bt_10">
                                <input type="text" id="txt_travel_total_expense1" name="txt_travel_total_expense" class="text-right amount_feild_highlight" value="0" title= "Total Travel Amount" readonly />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg_white main_block panel-default-inner">
                        <div class="col-xs-12">
                            <div class="panel panel-default panel-body pad_8 mg_bt_10 mg_tp_10 legend_pan bk_payment_wrap">
                                <div class="row"> 
                                    <div class="col-xs-12"> <label class="legend_text">Tour</label> </div> 
                                </div>
                                <div class="row">
                                    <div class="chk_wrap">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                        <select id="cmb_payment_mode1" title="Mode"  name="cmb_payment_mode1" onchange="payment_installment_enable_disable_fields('1')">
                                             <?php get_payment_mode_dropdown(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                        <input type="text" id="txt_amount1" name="txt_amount1" title="Amount" placeholder="*Amount" class="text-right" onchange="validate_balance(this.id);payment_amount_validate(this.id,'cmb_payment_mode1','txt_transaction_id1','txt_bank_name1')" />
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-default panel-body pad_8 mg_bt_0 legend_pan bk_payment_wrap" style="margin-top: 30px;">
                                <div class="row"> 
                                    ...
                                    <div class="row">
                                    <div class="chk_wrap">
                                        <input type="checkbox" id="chk_pay_for_traveling" checked>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-12 text_center_xs mg_bt_10_xs">
                                        <select id="cmb_payment_mode2" title="Mode" name="cmb_payment_mode2" onchange="payment_installment_enable_disable_fields('2')">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="row text-center mg_bt_20">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12 text_center_xs mg_bt_10_sm_xs">
                                    <input type="text" id="txt_balance_due_date" name="txt_balance_due_date" name="txt_balance_due_date" placeholder="Due Date" title="Due Date" />
                                </div>
                                <div class="col-md-4 col-sm-6 col-xs-12 text_center_xs mg_bt_10_sm_xs">
                                    <input type="text" id="txt_date" name="txt_date" placeholder="Booking Date" title="Booking Date" value="<?php echo date('d-m-Y H:i:s') ?>" onchange="check_valid_date(this.id)" />
                                </div>
