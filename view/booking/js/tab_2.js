       ...
       if(row.cells[0].childNodes[0].checked)
       {
        ...
        if(from_city_id1=="")

          {
                ...
                error_msg_alert('Enter plane from city in row'+current_row);
                 row.cells[3].childNodes[0].focus();
                return false;
...

           {
              ...
              error_msg_alert('Enter plane from location in row'+current_row);
               row.cells[4].childNodes[0].focus();
              return false;
...

          {
                ...
                error_msg_alert('Enter plane To city in row'+current_row);
        ...
        if(to_location1 == "")
        {
          error_msg_alert("Enter to location for plane details at row"+current_row);
          row.cells[6].childNodes[0].focus();
          return false;
        }  
        if(company1 == "")
        {
