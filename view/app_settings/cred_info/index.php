	...
	<div class="row mg_tp_20 mg_bt_20">
		...
		<div class="col-md-4">
			<select id="app_smtp_status" name="app_smtp_status" title="SMTP Status">
				<?php 
				if($sq_settings['app_smtp_status']!=""){
					?>
...
<div class="panel panel-default panel-body app_panel_style feildset-panel mg_bt_30">
	...
	<div class="row mg_tp_20 mg_bt_20">
		...
		<div class="col-md-4">
			<input type="password" id="current_password" name="current_password" onchange="validate_password(this.id)" class="form-control" placeholder="Current password" title="Current password" value="<?= $sq_password['password'] ?>">
		</div>
			<a onclick="show_password('current_password')" target="_BLANK" class="btn btn-info btn-sm" title="View Password" style="background-color: #009898;"><i class="fa fa-eye"></i></a>
	...
	<div class="row mg_bt_20">
		...
		<div class="col-md-4">
			<input type="text" id="new_password" onchange="validate_password(this.id)" placeholder="New password" title="New password">
		</div>
		<div class="col-md-2 text-right"><label for="re_password">Confirm password</label></div>
		<div class="col-md-4">
			<input type="text" id="re_password" onchange="validate_password(this.id)" placeholder="Confirm password" title="Confirm password">
		</div>
	</div>
</div>
