...
?>
<?= begin_panel('Excursion Supplier Information',26) ?>
...
<div class="row text-right mg_bt_20">
    <div class="col-md-12">
    	...
    	&nbsp;&nbsp;
        <button class="btn btn-info btn-sm ico_left" id="btn_save_modal" onclick="save_modal()"><i class="fa fa-plus"></i>&nbsp;&nbsp;Excursion Supplier</button>
    </div>
</div>
