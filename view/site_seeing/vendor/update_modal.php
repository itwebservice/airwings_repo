      ...
      <div class="modal-body">
      	<div class="panel panel-default panel-body app_panel_style feildset-panel">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 mg_bt_10">
					<input type="text" id="mobile_no" name="mobile_no"  onchange="mobile_validate(this.id);" placeholder="Mobile No" title="Mobile No" value="<?= $sq_vendor['mobile_no'] ?>">
				</div>
				<div class="col-md-3 col-sm-6 mg_bt_10">
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 mg_bt_10">
					<input type="text" id="email_id" name="email_id" placeholder="Email ID" title="Email ID" value="<?= $sq_vendor['email_id'] ?>">
				</div>
				<div class="col-md-3 col-sm-6 mg_bt_10">
			...
			<div class="row">
				<div class="col-sm-3 col-xs-6 mg_bt_10">
		            <select name="cust_state1" id="cust_state1"  title="Select State" placeholder="select state" style="width:100%">
           ...
           <div class="panel panel-default panel-body app_panel_style feildset-panel">
				...
				<div class="row"> 
					<div class="col-md-3 col-sm-6 mg_bt_10">
		          	...
		          	<div class="col-md-3 col-sm-6 mg_bt_10">
						<input type="text" id="opening_balance" name="opening_balance" placeholder="Opening Balance" title="Opening Balance" value="<?= $sq_vendor['opening_balance'] ?>" <?= $value ?>  onchange="validate_balance(this.id)">
					</div>  
					<div class="col-sm-3 mg_bt_10">
						<input type="text" id="as_of_date1" name="as_of_date1" placeholder="*As of Date" title="As of Date" value="<?= get_date_user($sq_vendor['as_of_date'])?>">
					</div>
					<div class="col-md-3 col-sm-6 mg_bt_10">
