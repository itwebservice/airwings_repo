        ...
        <div class="row mg_bt_20">
          <div class="col-md-4">
           <select id="type1" name="type" style="width: 100%;" title="Select Type">
		    ...
		    <div class="row mg_bt_20">
			   <div class="col-md-12">
				    <input type="text" id="title" name="title" placeholder="*Title" title="Title" class="form-control">
			   </div>
		    </div>
	  	  ...
	  	  <div class="row mg_tp_10">
	  		   <div class="col-md-12">
	  			    <select name="active_flag" id="active_flag" title="Active Flag" class="form-control hidden">
  ...
  $('#frm_save').validate({
    ...
    submitHandler:function(form){
        ...
        $.post(
               ...
               { type : type, title : title, terms_and_conditions : terms_and_conditions, active_flag : active_flag, branch_admin_id : branch_admin_id },
               function(data) {
