    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row mg_bt_20">
          ...
          <div class="col-md-6">
            <select name="active_flag" id="active_flag" title="Active Flag" class="form-control">
    		...
    		<div class="row mg_bt_20">
    			<div class="col-md-12">
    				<input type="text" id="title" name="title" placeholder="Title" title="Title" value="<?= $sq_terms['title'] ?>" class="form-control">
    			</div>
    		</div>
  ...
  $('#frm_update').validate({
    ...
    submitHandler:function(form){
        ...
        $.post(
               ...
               { type : type,terms_and_conditions_id : terms_and_conditions_id, title : title, terms_and_conditions : terms_and_conditions, active_flag : active_flag },
               function(data) {
