							        		...
							        		<div class="row">
           										...
           										<div class="col-md-6 right_border_none_sm" style="border-right: 1px solid #ddd">
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Mobile No <em>:</em></label> " .$sq_transport_agency['mobile_no']; ?> 
							        				...
							        				<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Email ID <em>:</em></label> " .$sq_transport_agency['email_id'] ; ?>
							        			...
							        			<div class="col-md-6">
							        				    ...
							        				    <?php echo "<label>Opening Balance <em>:</em></label> " .$sq_transport_agency['opening_balance']; ?> 
															 ...
															 <span class="main_block">
																 ...
																 <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
																	 ...
																	 <?php echo "<label>As Of Date <em>:</em></label> " .get_date_user($sq_transport_agency['as_of_date']); ?> 
													...
													<span class="main_block">
							        				    ...
							        				    <?php echo "<label>Side <em>:</em></label> " .$sq_transport_agency['side']; ?> 
							        				...
							        				<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i> 
							        				    ...
							        				    <?php echo "<label>Active Flag <em>:</em></label> " .$sq_transport_agency['active_flag']; ?>
