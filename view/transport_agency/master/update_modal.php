    ...
    <input type="hidden" id="vendor_login_id" name="vendor_login_id" value="<?= $sq_vendor_login['login_id'] ?>">
		  <div class="row">
		    <div class="col-md-3 col-sm-6 mg_bt_10">
		      <select id="cmb_city_id" name="cmb_city_id" style="width:100%" onchange="tour_city_list_load(this.id)" class="form-control" title="City Name">
		    ...
		    <div class="col-md-3 col-sm-6 mg_bt_10">
		      <input type="text" class="form-control"  onchange="mobile_validate(this.id);" id="txt_mobile_no" name="txt_mobile_no" placeholder="Mobile Number" title="Mobile Number" value="<?php echo $sq_transport_agency['mobile_no'] ?>">
		    </div>	
        <div class="col-md-3 col-sm-6 mg_bt_10">
      ...
      <div class="row">   
        <div class="col-md-3 col-sm-6 mg_bt_10">
          <input type="text" class="form-control"  id="txt_email_id" name="txt_email_id"  placeholder="Email ID" title="Email ID" value="<?php echo $sq_transport_agency['email_id'] ?>">
        </div>  
        <div class="col-md-3 col-sm-6 mg_bt_10">
    ...
    <legend>Bank Information</legend>
      ...
      <div class="row"> 
        <div class="col-md-3 col-sm-6 mg_bt_10">
          ...
          <div class="col-md-3 col-sm-6 mg_bt_10">
              <input type="text" id="opening_balance" name="opening_balance" placeholder="Opening Balance" title="Opening Balance" value="<?php echo $sq_transport_agency['opening_balance'] ?>" <?= $value ?>  onchange="validate_balance(this.id)">
          </div>
          <div class="col-sm-3 mg_bt_10">
            <input type="text" id="as_of_date1" name="as_of_date1" placeholder="*As of Date" title="As of Date" value="<?= get_date_user($sq_transport_agency['as_of_date']) ?>">
          </div>
          <div class="col-md-3 col-sm-6 mg_bt_10">
            <select name="side1" id="side1" title="Select side" disabled>
...
$('#cmb_city_id,#cust_state1').select2();
