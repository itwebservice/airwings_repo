                         ...
                         <div class="row text-left">
                          ...
                          <div class="col-md-12">
                           ...
                           while($row = mysql_fetch_assoc($sq_enquiries)){ 
                              $sq2 = "select * from enquiry_master_entries where entry_id=(select max(entry_id) as entry_id from enquiry_master_entries where enquiry_id='$row[enquiry_id]') and followup_date between '$rightnow' and '$add7days'";
                                $sq3 = mysql_query($sq2);
