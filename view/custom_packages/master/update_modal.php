    ...
    <div class="modal-content">
      ...
      <input type="hidden" value="<?php echo $sq_pckg['package_id']; ?>" id="package_id1">
        ...
        <div class="row mg_bt_20"> 
            ...
            <div class="col-md-1 col-sm-6 mg_bt_10_xs"> 
        ...
        <div class="col-xs-12 text-right mg_tp_10">
         ...
         ?>
              <tr>
                  <td><input id="chk_dest1" type="checkbox" checked disabled></td>
        ...
        <div class="col-xs-12 text-right mg_tp_10">
         ...
         <?php
          ...
          ?>
              ...
              <script type="text/javascript">
              $('#vehicle_name1<?php echo $count_hotel; ?>-u').select2(); </script>
              <?php } } ?>                               
        ...
        <div class="row mg_bt_20">                         
            ...
            <div class="col-md-6 col-sm-6 mg_bt_10_sm_xs">
                ...
                <textarea  class="feature_editor" id="inclusions1" name="inclusions" placeholder="Inclusions" title="Inclusions"><?php echo $sq_pckg['inclusions']; ?></textarea>

            </div>      

            <div class="col-md-6 col-sm-6"> 
                <h3 class="editor_title">Exclusions</h3>
                <textarea class="feature_editor" id="exclusions1" name="exclusions" class="form-control"  placeholder="Exclusions" title="Exclusions"><?php echo $sq_pckg['exclusions']; ?></textarea>
    ...
    submitHandler:function(form){
       ...
       //Hotel information
        ...
        $.post(
                   ...
                   { package_id : package_id, package_code : package_code, package_name : package_name, total_days : total_days, total_nights : total_nights, status : status, transport_id : transport_id, city_name_arr : city_name_arr, hotel_name_arr : hotel_name_arr, hotel_type_arr : hotel_type_arr, total_days_arr : total_days_arr,inclusions : inclusions, exclusions : exclusions,checked_programe_arr:checked_programe_arr, day_program_arr : day_program_arr, special_attaraction_arr : special_attaraction_arr,overnight_stay_arr : overnight_stay_arr,meal_plan_arr : meal_plan_arr, entry_id_arr : entry_id_arr, hotel_entry_id_arr : hotel_entry_id_arr,vehicle_name_arr:vehicle_name_arr,cost_name_arr:cost_name_arr,tr_entry_arr:tr_entry_arr,child_cost : child_cost,adult_cost : adult_cost,infant_cost: infant_cost,child_with : child_with,child_without: child_without,extra_bed:extra_bed },
