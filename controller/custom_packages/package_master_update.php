...
$cost_name_arr = $_POST['cost_name_arr'];
...
$package_master1->package_master_update($package_id1,$dest_id,$package_code,$package_name,$total_days,$total_nights,$transport_id,$inclusions,$exclusions, $status ,$city_name_arr, $hotel_name_arr, $hotel_type_arr,$total_days_arr,$vehicle_name_arr,$cost_name_arr,$tr_entry_arr,$checked_programe_arr, $day_program_arr,$special_attaraction_arr,$overnight_stay_arr,$meal_plan_arr, $entry_id_arr,$hotel_entry_id_arr,$adult_cost,$child_cost,$infant_cost,$child_with,$child_without,$extra_bed);
