...
$connection=mysql_connect("localhost","itourscl_airw_u","lO&&UqUrNF~3");
if(!$connection){ echo "Unable To make Connection."; }

$db_connect=mysql_select_db("itourscl_airwings");
if(!$db_connect) { echo "Database Not Connected."; }

define('BASE_URL', 'https://airwings.itourscloud.com/');
