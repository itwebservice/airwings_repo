...
public function finance_save($refund_id)
{
    ...
    $payment_particular = get_refund_paid_particular(get_bus_booking_id($booking_id,$yr), $refund_date, $refund_amount, $refund_mode,get_bus_booking_refund_id($refund_id,$yr1));
    $ledger_particular = '';
    $gl_id = $pay_gl;
    $payment_side = "Credit";
    $clearance_status = "";
...
public function bank_cash_book_save($refund_id)
{
	...
	$transaction_id = $transaction_id;
	$bank_id = $bank_id;
	$particular = get_refund_paid_particular(get_bus_booking_id($booking_id,$yr), $refund_date, $refund_amount, $refund_mode, get_bus_booking_refund_id($refund_id,$yr1));
...
global $app_email_id, $app_name, $app_contact_no, $admin_logo_url, $app_website;
 ...
 <tr>
    <td>
        <table cellspacing="0" style="width:100%">
	      ...
	      <tr>
	         ...
	         <p style="line-height: 24px;padding: 0 0 0 15px;">Booking ID : '.$sq_sq_bus_info['booking_id'].'</p>
  ...
  $model->app_email_send('37',$cust_email['email_id'], $content, $subject);
 }
