...

{
      ...
      <table style="padding:0 30px;width: 100%;">
        ...
        <tr>
          ...
          <td colspan="2">
            ...
            '.mail_login_box($username, $password, BASE_URL).'
  ...
  global $model;
  $model->app_email_send('1',$email_id, $content,$subject,'1');
...
public function employee_sign_up_sms($first_name, $last_name,$username, $password, $mobile_no1)
{
   ...
   $message = "Dear ".$first_name." ".$last_name.",Congratulations for join the ".$app_name." FAMILY.  Your Login Details are 
      L : ".BASE_URL."  
      U : ".$username." 
      P : ".$password.". 
