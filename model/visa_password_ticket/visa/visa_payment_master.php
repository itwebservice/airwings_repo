...
public function payment_email_notification_send($visa_id, $payment_amount, $payment_mode, $payment_date)
{
   ...
   $sq_total_amount = mysql_fetch_assoc(mysql_query("select sum(payment_amount) as sum from visa_payment_master where visa_id='$visa_id'"));
   ...
   global $model;
   $model->generic_payment_mail('47',$payment_amount, $payment_mode, $total_amount, $paid_amount, $payment_date, $email_id, $subject, $payment_id);
}
...
public function payment_update_email_notification_send($payment_id)
{
	...
	global $model;
   	$model->generic_payment_mail('57',$payment_amount, $payment_mode, $total_amount, $paid_amount, $payment_date, $email_id,$subject, $update_payment);
