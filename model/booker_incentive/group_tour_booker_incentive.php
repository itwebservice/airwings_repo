...
public function group_tour_booker_incentive_save()
{
	...
	$sq = mysql_query("insert into booker_incentive_group_tour ( incentive_id, emp_id, tourwise_traveler_id, basic_amount, tds, incentive_amount ) values( '$incentive_id', '$emp_id', '$tourwise_traveler_id', '$basic_amount', '$tds', '$incentive_amount' )");
