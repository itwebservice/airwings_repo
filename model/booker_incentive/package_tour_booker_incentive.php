...
public function package_tour_booker_incentive_save()
{
	...
	$sq = mysql_query("insert into booker_incentive_package_tour ( incentive_id, emp_id, booking_id, basic_amount, tds, incentive_amount ) values( '$incentive_id', '$emp_id', '$booking_id', '$basic_amount', '$tds', '$incentive_amount' )");
