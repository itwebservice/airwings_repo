...
$in = 'in';
  ...
  $tour_cost = $sq_costing['tour_cost'] + $sq_costing['markup_subtotal']+ $sq_costing['transport_cost']+ $sq_costing['excursion_cost'];
        ...
        <div class="col-md-12">
          ...
          <div class="adolence_info">
            ...
            <?php if($sq_quotation['costing_type'] == 1){ ?>
              <div class="row">
                <li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10"><span>Tour Cost : </span><?= number_format($tour_cost,2); ?></li>

                <li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10 sm_r_brd_r8"><span>Tax : </span><?=number_format($sq_costing['service_tax_subtotal'],2); ?></li>
                ...
                <li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10_xs sm_r_brd_r8 highlight" style="font-weight: 600; color: #016d01;"><span class="highlight">Quotation Cost : </span><?=number_format($sq_costing['total_tour_cost'] + $sq_quotation['train_cost']+ $sq_quotation['flight_cost'] + $sq_quotation['cruise_cost'] + $sq_quotation['visa_cost'] + $sq_quotation['guide_cost'] + $sq_quotation['misc_cost'],2); ?></li>
              ...
              <div class="row">
                ...
                <?php if($sq_costing['child_cost']!='0'){?><li class="col-md-4 col-sm-6 col-xs-12"><span>Child Cost : </span><?=number_format($sq_costing['child_cost'],2); ?></li> <?php } ?>
                ...
                <?php if($sq_costing['extra_bedc']!='0'){?><li class="col-md-4 col-sm-6 col-xs-12"><span>Extra Bed Cost : </span><?=number_format($sq_costing['extra_bedc'],2); ?></li> <?php } ?>
              </div>
              <?php } ?>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="footer_company_cont text-right text_left_sm_xs">
