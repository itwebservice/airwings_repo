...

{
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_master"); 
	while ($r=mysql_fetch_assoc($result)) {
	   $cols[]= $r["Field"];
	}

	$result = mysql_query("SELECT * FROM package_tour_quotation_master WHERE quotation_id='$quotation_id'");
	while($r=mysql_fetch_array($result)) {
		...
		if(!$sq_quot){
			...
			$sq_update  = mysql_query("update package_tour_quotation_master set clone='yes' where quotation_id='$quotation_max'");
...

{
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_transport_entries2"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_transport_entries2 WHERE quotation_id='$quotation_id'");
...
public function clone_train_entries($quotation_id, $quotation_max){
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_train_entries"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_train_entries WHERE quotation_id='$quotation_id'");
...
public function clone_plane_entries($quotation_id, $quotation_max){
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_plane_entries"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_plane_entries WHERE quotation_id='$quotation_id'");
...
public function clone_cruise_entries($quotation_id, $quotation_max){
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_cruise_entries"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_cruise_entries WHERE quotation_id='$quotation_id'");
...
public function clone_hotel_entries($quotation_id, $quotation_max){
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_hotel_entries"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_hotel_entries WHERE quotation_id='$quotation_id'");
	  ...
	  while($r=mysql_fetch_array($result)) {
		    ...
		    foreach($cols as $counter=>$col) {
			  ...
			  $sq_hotel = mysql_query($insertSQL);
...

{
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_excursion_entries"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_excursion_entries WHERE quotation_id='$quotation_id'");
...
{	
	...
	$result = mysql_query("SHOW COLUMNS FROM package_quotation_program"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_quotation_program WHERE quotation_id='$quotation_id'");
...
public function clone_costing_entries($quotation_id, $quotation_max){
	...
	$result = mysql_query("SHOW COLUMNS FROM package_tour_quotation_costing_entries"); 
	 ...
	 while ($r=mysql_fetch_assoc($result)) {
	  ...
	  $result = mysql_query("SELECT * FROM package_tour_quotation_costing_entries WHERE quotation_id='$quotation_id'");
