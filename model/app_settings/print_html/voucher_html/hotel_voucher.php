...
$country_name = $sq_customer_name['country'];
      ...
      <div class="row">
        ...
        <div class="col-md-6 mg_bt_20">
          <ul class="print_info_list no-pad noType">
            ...
            <li><span>NATIONALITY :</span> <?= $country_name ?></li>
          </ul>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="print_info_block">
            <ul class="main_block noType">
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>ADULT : </span><?= $sq_booking['adults'] ?></li>
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>CHILDREN : </span><?= $sq_booking['childrens'] ?></li>
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>INFANT : </span><?= $sq_booking['infants'] ?></li>
            </ul>
            <ul class="main_block noType">
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>CHECK-IN : </span><?= date('d-m-Y H:i',strtotime($sq_accomodation['check_in'])) ?></li>
              <li class="col-md-6 mg_tp_10 mg_bt_10"><span>CHECK-OUT : </span><?= date('d-m-Y H:i',strtotime($sq_accomodation['check_out'])) ?></li>
            </ul>
            <ul class="main_block noType">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="print_text_bolck">
            <?php
            echo $sq_service_voucher1['terms_and_conditions']; 
            ?>
          </div>
        </div>
      </div>
