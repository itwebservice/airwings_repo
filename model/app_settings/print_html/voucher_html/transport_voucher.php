...
$from_date = date("d-m-Y", strtotime($sq_booking['tour_from_date']));
$to_date = date("d-m-Y", strtotime($sq_booking['tour_to_date']));
$row_transport =  mysql_fetch_assoc(mysql_query("select * from package_tour_transport_master where booking_id='$booking_id'")) ;

$q_transport = mysql_fetch_assoc(mysql_query("select * from transport_agency_bus_master where bus_id='$row_transport[transport_bus_id]'"));

$sq_traveler = mysql_fetch_assoc(mysql_query("select * from package_travelers_details where booking_id='$sq_booking[booking_id]' "));
$name = $sq_traveler['first_name'].' '.$sq_traveler['last_name'];
$contact_no = $sq_traveler['contact_no'];
$email_id = $sq_traveler['email_id'];
$sq_booking_cust = mysql_fetch_assoc(mysql_query("select * from customer_master where customer_id='$sq_booking[customer_id]'"));
$cust_name = $sq_booking_cust['first_name'].' '.$sq_booking_cust['last_name'];
$nationality = $sq_booking_cust['country'];
...
$sq_total_adult = mysql_num_rows(mysql_query("select traveler_id from package_travelers_details where booking_id='$booking_id' and adolescence='Adult'"));
$sq_total_child = mysql_num_rows(mysql_query("select traveler_id from package_travelers_details where booking_id='$booking_id' and adolescence='Children'"));
$sq_total_infant = mysql_num_rows(mysql_query("select traveler_id from package_travelers_details where booking_id='$booking_id' and adolescence='Infant'"));
//Total days
...
?>
    <section class="print_header main_block">
      ...
      <span class="title"><i class="fa fa-file-text"></i>SERVICE VOUCHER</span>
            ...
            <ul class="main_block noType">
              <li class="col-md-4 mg_tp_10 mg_bt_10">
                <div class="print_quo_detail_block">
                  ...
                  <span>TOTAL GUEST</span><?= ' - '.$sq_total_members ?><br>
                  <?php echo $sq_total_adult.' - Adult, '.$sq_total_child.' - Children, '.$sq_total_infant.' - Infant '; ?><br>
                </div>
              </li>
              <li class="col-md-4 mg_tp_10 mg_bt_10">
                <div class="print_quo_detail_block">
    ...
    <section class="print_sec main_block">
      ...
      <li><span>CONTACT NUMBER :</span> <?= $sq_booking['mobile_no'] ?></li>
      <li><span>NATIONALITY :</span> <?= $nationality ?></li>
      </ul>
      </div>
      <div class="col-md-6 mg_bt_20">
      <ul class="print_info_list no-pad noType">
      <li><span>TOUR NAME :</span> <?= $sq_booking['tour_name'] ?></li>
        ...
        <div class="col-md-12">
         <div class="table-responsive">
          <table class="table table-bordered no-marg" id="tbl_emp_list">
            ...
            {  
              $q_transport = mysql_fetch_assoc(mysql_query("select * from transport_agency_bus_master where bus_id='$row_tr_acc[transport_bus_id]'"));
 ...
 <?php if($sq_service_voucher['inclusions'] != ''){?> 
    <section class="print_sec main_block">
      <div class="row">
        ...
        <div class="col-md-12">
        <div class="print_text_bolck main_block">
          <div class="col-md-6">
          <div class="section_heding">
            <h2>INCLUSIONS</h2>
            <div class="section_heding_img">
    ...
    <div class="row">
        <div class="col-md-12">
          <div class="print_info_block">
            <ul class="main_block noType">
              <li class="col-md-12 mg_tp_10 mg_bt_10"><span>SPECIAL NOTE : </span><?= $sq_service_voucher['special_arrangments'] ?></li>
            </ul>
          </div>
        </div>
      </div>
