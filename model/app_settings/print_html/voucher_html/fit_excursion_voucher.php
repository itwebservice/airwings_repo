...
?>
    <section class="print_header main_block">
      ...
      <span class="title"><i class="fa fa-file-text"></i> EXCURSION SERVICE VOUCHER</span>
    ...
    <section class="print_sec main_block">
      ...
      <div class="row">
        ...
        <div class="col-md-5 mg_bt_20">
          <ul class="print_info_list no-pad noType">
            <li><span>TOTAL GUEST :</span> <?= $sq_pass_count ?></li>
          </ul>
        </div>
      </div>
    </section>
         ...
         <div class="table-responsive">
          <table class="table table-bordered no-marg" id="tbl_emp_list">
            ...
            while($row_exc_acc=mysql_fetch_assoc($sq_exc_acc)){
              ...
              $sq_exc_name = mysql_fetch_assoc(mysql_query("select * from itinerary_paid_services where service_id='$row_exc_acc[exc_id]'"));
            ?>
                <tr>
                  <td><?= $sq_city_name['city_name'] ?></td>
                  <td><?= $sq_exc_name['service_name'] ?></td>
                </tr>
            <?php } ?>
            </tbody>
          </table>
