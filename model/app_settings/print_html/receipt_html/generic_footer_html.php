...
<section class="print_sec main_block inv_rece_footer_bottom">
  ...
  <div class="border_block inv_rece_back_detail">
		<div class="row">
			...
			<div class="col-md-6"><p class="border_lt no-marg"><span class="font_5">SWIFT : </span><?= ($branch_status=='yes' && $role!='Admin') ? $branch_details['swift_code'] : $bank_swift_code ?></p></div>
		</div>
	</div>
</section>
