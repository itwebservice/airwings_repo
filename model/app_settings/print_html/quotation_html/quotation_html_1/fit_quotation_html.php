...
?>
    ...
    <section class="print_sec main_block side_pad mg_tp_10">
        <div class="row text-center">
          <h4>TOUR NAME : </span> <?= $sq_package_name['package_name'].'('.$sq_package_name['package_code'].')' ?> </h4>
          <h4>QUOTATION ID : </span><?= get_quotation_id($quotation_id,$year) ?> </h4>
        </div>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="print_info_block">
            ...
            <ul class="main_block">
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>ADULT COST : </span><?= number_format($sq_costing['adult_cost'],2) ?></li>
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>CHILD COST : </span><?= number_format($sq_costing['child_cost'],2) ?></li>
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>INFANT COST : </span><?= number_format($sq_costing['infant_cost'],2) ?></li>
            </ul>
            <ul class="main_block">
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>CHILD WITH BED : </span><?= number_format($sq_costing['child_with'],2) ?></li>
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>CHILD W/O BED : </span><?= number_format($sq_costing['child_without'],2) ?></li>
              <li class="col-md-4 mg_tp_10 mg_bt_10"><span>EXTRA BED : </span><?= number_format($sq_costing['extra_bedc'],2) ?></li>
            </ul>
              <?php } ?>
          </div>
        </div>
  ...
  ?>
    ...
    <div class="row mg_tp_30">
        ...
        <div class="col-md-12">
          ...
          <div class="print_text_bolck">
           <?php echo $sq_quotation['special_request']; ?>
          </div>
        </div>
      </div>
    </div>
