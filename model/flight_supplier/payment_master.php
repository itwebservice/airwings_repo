...
public function finance_save($payment_id,$ledger_id,$vendor_name)
{
    ...
    $payment_particular = get_advance_purchase_particular($vendor_name);
    $ledger_particular = '';
    $gl_id = $pay_gl;
    $payment_side = "Credit";
...
public function bank_cash_book_save($advance_id,$vendor_name)
{
	...
	$transaction_id = $transaction_id1;
	$bank_id = $bank_id;
	$particular = get_advance_purchase_particular($vendor_name);
	$clearance_status = ($payment_mode=="Cheque") ? "Pending" : "";
	$payment_side = "Credit";
...
public function bank_cash_book_update($clearance_status1)
{
	...
	$transaction_id = $transaction_id1;
	$bank_id = $bank_id;
	$particular = get_flight_supplier_particular($payment_mode, $payment_date1, $payment_amount1);
