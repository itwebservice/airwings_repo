...
function tour_group_reflect(id)
{
  var base_url = $('#base_url').val();
...
function payment_installment_enable_disable_fields(offset='')
{
  ...
  if(payment_mode=='Cash' || payment_mode=='Credit Note')
  {
  ...
  if(payment_mode=='Cheque' || payment_mode=='NEFT' || payment_mode=='RTGS' || payment_mode=='IMPS' || payment_mode=='DD' || payment_mode =='Credit Card'|| payment_mode=='Online' || payment_mode=='Other')
  {
